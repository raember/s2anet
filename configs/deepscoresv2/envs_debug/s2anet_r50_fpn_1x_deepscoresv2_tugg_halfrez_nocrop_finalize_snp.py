...
train_pipeline = [
    ...
    dict(type='ScoreAug', blank_pages_path=data_root + 'blanks', p_blur=0.1, p_augment=0.5, p_snp = 0.5),
...
wandb_cfg = dict(
    entity="tuggeluk",
    project='s2anet_scoreaug_test_env',
    dryrun=False,
    name_prefix = ""
)
...
log_level = 'INFO'
load_from = '/home/ubuntu/conda_based_run/s2anet/work_dirs/s2anet_r50_fpn_1x_deepscoresv2_tugg_halfrez_nocrop_finalize_snp/latest.pth'
resume_from = None
workflow = [('train', 1)]
