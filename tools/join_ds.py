...
ann_in_1 = OBBAnns('../ili_subset/scores.json')
ann_in_2 = OBBAnns('data/deep_scores_dense/deepscores_test.json')
...
print("Join image data")
for _img_info in ann_in_1.img_info:
...
with open(ann_out_path, 'w') as fp:
