...
class BaseDetectorDA(nn.Module):
    """Base class for detectors"""

    __metaclass__ = ABCMeta

    def __init__(self):
        super(BaseDetectorDA, self).__init__()
    ...
    @abstractmethod
    def forward_train_src(self, imgs, img_metas, **kwargs):
        """
        Args:
        ...
        pass
    @abstractmethod
    def forward_train_tgt(self, imgs, img_metas, **kwargs):
        """
        Args:
            img (list[Tensor]): list of tensors of shape (1, C, H, W).
                Typically these should be mean centered and std scaled.
