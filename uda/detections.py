...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_file', help='input config file',default = './configs/deepscoresv2/s2anet_r50_fpn_1x_deepscoresv2_ghos_lowrez.py')
    parser.add_argument('--model', help='pretrain model',default = './models/epoch_500.pth')
    parser.add_argument('--img_dir', help='img dir', default='./data//imslp_dataset/images/clean_scans/')
    parser.add_argument('--out_dir', help='output dir', default ='./uda/results/detections/ext_feat/')
